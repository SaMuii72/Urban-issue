          ...
          >
            <Popup className="modern-popup">
              <div style={{ padding: '0.2rem', minWidth: '220px' }}>
                <strong style={{ fontSize: '1rem', display: 'block', marginBottom: '0.4rem', color: '#0f172a', fontWeight: 800, lineHeight: 1.2 }}>
                  {formatTitle(event.title)}
                </strong>
                <div style={{ fontSize: '0.75rem', color: '#64748b', marginBottom: '0.8rem', display: 'flex', alignItems: 'center', gap: '4px', fontWeight: 500 }}>
